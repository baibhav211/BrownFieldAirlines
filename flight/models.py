...
class Flight(models.Model):
    ...
    plane = models.CharField(max_length=24) #  this is flight number
...
#     # is_aisle = models.BooleanField()
#     # is_window = models.BooleanField()
#     def __str__(self):
#         return f"Passenger: {self.first_name} {self.last_name}, {self.gender}, {self.isbooked}"
